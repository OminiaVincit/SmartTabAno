...
# File: ComplexityEntropAir.R
# Do: get complexity : ApEntropy and SaEntropy (Ubuntu_version)
...
for (i in 85:99) {
  ...
  if (numberDataPoints > samplePoints) {
    ...
    #                                   
    #       ApSa <- AppSamEn(sData, numberDataPoints, 2, timeLag1, 0.2*std)
    #       NApSa <- AppSamEn(noiseData, numberDataPoints, 2, timeLag2, 0.2*nstd)
    #       print(c(i, idName, timeLag1, timeLag2, std, nstd, ApSa, NApSa))
    #       
    #     }
    ...
    # print to csv file
    resultFile <- paste("../Data/IREF/November_result/",idName, "-",fromDay,"-",toDay,"-",numberDataPoints,".csv",sep="")
